...
import { CUSTOM_ICONS } from './shared/icons';
...
const alainConfig: AlainConfig = {
  ...
  st: {
    req: {
      type: 'skip',
      reName: { pi: 'page', ps: 'page_size', skip: 'offset', limit: 'limit' }
    },
    res: {
      reName: {
        total: 'count',
...
const providers: Array<Provider | EnvironmentProviders> = [
  ...
  provideAlain({ config: alainConfig, defaultLang, i18nClass: I18NService, icons: [...ICONS_AUTO, ...ICONS, ...CUSTOM_ICONS] }),
